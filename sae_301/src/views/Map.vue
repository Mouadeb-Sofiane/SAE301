...
<template>
    <div class="container-fluid" style="color: black;">
        ...
        <br>
        <br>
        <h1 style="text-align: center;">Recherche des ophtalmologues</h1>
        <br><br>
        <h2>Vous pouvez Rechercher des opthalmologogues avec lesquelles nous sommes associés. Vous avez besoins des ophtalmologues pour votre santé Oculaire. Nous devons prendre soin de nos yeux car nous en avons que 2.</h2>
